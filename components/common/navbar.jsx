  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900 relative">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-3">
        ...
        <div
          className="absolute top-full left-0 right-0 hidden md:relative md:flex md:top-auto md:left-auto md:right-auto md:w-auto"
          id="navbar-user"
        >
          <NavigationMenuDemo />
        </div>
        ...
        {isMenuOpen && (
          <div
            className="absolute top-full left-0 right-0 md:relative md:flex md:top-auto md:left-auto md:right-auto md:w-auto"
            id="navbar-user"
          >
            <NavigationMenuDemo />
          </div>
